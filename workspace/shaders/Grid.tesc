...
//        gl_TessLevelInner[1] = max(tes0, tes2); // left right for quads
        ...
        gl_TessLevelOuter[0] = 16; // left for quads
        gl_TessLevelOuter[1] = 16; // bottom for quads
        gl_TessLevelOuter[2] = 16; // right for quads
        gl_TessLevelOuter[3] = 16; // top for quads
        gl_TessLevelInner[0] = 16; // up down for quads
        gl_TessLevelInner[1] = 16; // left right for quads
